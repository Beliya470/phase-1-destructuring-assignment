...
// 3. Little the chicken had to go back to the coop, so now we're left with three. Let's use color variables of cow, black, and pink.
const [cow, , black, pink] = farmAnimals.split(' ');
